const CACHE='chuhe-shell-v1.23.0';
const CORE=['/','/index.html','/style.css','/favicon.svg','/app.js','/jieqi-covered.css','/sandbox-pink-frame.css','/sandbox-gomoku-architecture.js','/chess-ui-updates.css','/chess-ui-updates.js','/connection-status.js','/enhancements-loader.js','/enhancements-runtime.css','/enhancements-runtime.js','/diagnostics.css','/diagnostics-client.js','/security-client.js','/responsive.css','/game-ux.css','/manifest.webmanifest','/pwa.css','/pwa-client.js','/record-system.css','/record-system.js','/history.css','/history-client.js','/accessibility.css','/accessibility.js','/performance-client.js','/platform-runtime.css','/platform-runtime.js','/realtime-client.js','/clock-client.js','/spectator-client.js','/ai-core.js','/ai-client.js','/analysis.css','/analysis-client.js','/timeout-finish.css','/timeout-finish.js','/match-panel.css','/solo-setup.css'];
