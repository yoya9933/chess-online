(() => {
  async function loadEnhancements() {
    ...
    try { const response = await fetch('/version.json', { cache: 'no-store' }); if (response.ok) { const info = await response.json(); cacheKey = info.commit || info.version || cacheKey; } } catch {}
    ...
    for (const file of ['enhancements-runtime.js','security-client.js','diagnostics-client.js','pwa-client.js','record-system.js','history-client.js','accessibility.js','performance-client.js','platform-runtime.js','realtime-client.js','clock-client.js','spectator-client.js','ai-core.js','ai-client.js']) {
