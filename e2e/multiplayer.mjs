...
console.log("[e2e] reconnect with header token and synchronize the same revision");
...
console.log("[e2e] reject a stale revision and lock side switching after the first move");
...
console.log("[e2e] Jieqi hides unrevealed identities at the HTTP boundary");
