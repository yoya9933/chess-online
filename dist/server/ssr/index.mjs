...
const clientReferences = {
  "f29e6e234fea": async () => {
    const m = await import("./assets/facade__virtual_vinext-rsc-entry-D33DM5bS.mjs");
...
async function handleSsr(rscStream, navContext, fontData) {
  return runWithNavigationContext(async () => {
    ...
    try {
      ...
      const { createElement: createElement$1, Fragment } = await import("react");
      let insertedHTML = "";
      for (const el of insertedElements) {
        try {
          insertedHTML += renderToStaticMarkup(createElement$1(Fragment, null, el));
        } catch {
        }
      }
      let fontHTML = "";
